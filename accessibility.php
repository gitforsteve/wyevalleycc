...
<div class="nine columns" style="padding-left:10px;">
  ...
  <p>If you have been unable to make the most of our site because of a difficulty in using it please contact us and we will try to address it. You can <a href="javascript:$('#postform').submit();" title="Display a form to send email">contact Steve Evans</a> via the email form.</p>
  <h2>PDF documents</h2>
  <p>While we do not generate <abbr title="portable document format, an Adobe standard">PDF</abbr> documents we do receive these from outside agencies and groups for display or link to pages where these are included, for example, the Tintern News.</p>
